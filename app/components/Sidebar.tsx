...
export function SideBar() {
    return(
        <div className="flex flex-col justify-between gap-8 p-4 py-12 w-60 h-screen bg-white z-[999] absolute">
            <div className="flex flex-col items-center gap-4">
                ...
                <div className="font-semidbold text-xl flex flex-col gap-2 w-full">
                    ...
                    <IconBtn href="/" text="Perfil" className="hover:bg-orange-500 hover:text-white " Icon={User}/>
